		...
		<form class="center_form" action="new_user_form_handler.php" method="POST" id="new_user_from">
			...
			<table cellpadding='10'>
				...
				<tr>
					...
					<td><input type="email" name="email" id="email" required><br><br></td>
				</tr>
			</table>
			<br>
			<table cellpadding='10'>
				...
				<tr>
					...
					<td><input type="text" name="phone_no" pattern="[0-9]{10}" title="Please enter a 10-digit phone number" required><br><br></td>
